...
<head>
    ...
    <title>INTI STUDENT ATTENDANCE MONITORING SYSTEM</title>
    <!-- Custom CSS -->
                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/inti.jpg);">
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="post" name="login">
                                    <h1 class="display-5 mb-10">INTI STUDENT ATTENDANCE MONITORING SYSTEM</h1>
...
<br>
<button style="background-color:#ff5454;border:#ff5454" class="btn btn-primary btn-block" type="submit" name="login">Login</button>
<br>
<a href="forgotpass.php" style="color:#ff6464;font-size:15px"><i><u>forget password?</u></i></a>
