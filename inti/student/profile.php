...
$matId=$_POST['matId'];
$sql="update tblstudents set parentId=:parentid,studentName=:stdname,studentAdress=:stdaddress,studentContact=:stdcontact,studentDob=:stddob,studentJoinDate=:jdate,studentMarticulationId=:matId,studentClass=:clname where id=:stdid";
...
$query->bindParam(':matId',$matId,PDO::PARAM_STR);
...
<head>
    ...
    <script>
function checkmatIdAvailability(cls,rln) {
var cls=$(".stdcls").val();
var rln=$(".matId").val();
var clsrln=cls+'$'+rln;
$("#loaderIcon").show();
...
$("#user-matIdavailability-status").html(data);
$("#loaderIcon").hide();
},
error:function (){}
});
...
<div class="row">
<div class="col-md-2 mt-15">Marticulation ID : </div>
<div class="col-md-6 mt-10">
<input class="form-control rollno" type="text" onBlur="checkmatIdAvailability()" name="matId" placeholder="Marticulation ID." required="true" value="<?php echo htmlentities($result->studentMarticulationId);?>"  autofocus>
<span id="user-matIdavailability-status" style="font-size:12px;"></span> 
</div>
</div>
