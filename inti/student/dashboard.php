									...
									<div class="card card-sm">
										<div class="card-body">
											<div class="d-flex justify-content-between mb-5">
												<div>
													<span class="d-block font-15 text-dark font-weight-500">Lecture</span>
												</div>
...
$counts1=$query->rowCount();
?>
<span class="d-block display-4  mb-5" style="color: orange"><?php echo htmlentities($counts1);?> Day Late</span>
												<small class="d-block">In Last 30 Days</small>
											</div>
										</div>
									</div>
...
<?php echo htmlentities($counts1absent);?> Day Absent</span>
									...
									<div class="card card-sm">
										<div class="card-body">
											<div class="d-flex justify-content-between mb-5">
												<div>
													<span class="d-block font-15 text-dark font-weight-500">Tutorial</span>
												</div>
											</div>
											<div>
<?php
...
?>
    ...
    <span class="d-block display-4 mb-5" style="color:orange"><?php echo htmlentities($counts2);?> Day Late </span>
												<small class="d-block">In Last 30 Days</small>
											</div>
										</div>
									</div>
...
<p class="lead" align="center" style="font-size:22px;color:black">Your Last 10  attendance
                                    </p>
                                    <hr/>
                            <div class="row">
                                <div class="col-sm">
