...
<td><input type="radio" name="attendance[<?php echo $result->id; ?>]" value="1" required="true" checked>P 
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="attendance[<?php echo $result->id; ?>]" value="2" required="true">L
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="attendance[<?php echo $result->id; ?>]" value="0" required="true">A 
 </td>
</tr>
