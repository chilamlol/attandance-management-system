...
$sql="INSERT INTO  tblstudents(parentId,studentName,studentAdress,studentContact,studentDob,studentJoinDate,studentMarticulationId,studentClass,studentUsername,studentPassword) VALUES(:parentid,:stdname,:stdaddress,:stdcontact,:stddob,:jdate,:matId,:clname,:susername,:spass)";
...
<div class="col-md-6 mt-10">
<input class="form-control rollno" type="text" onBlur="checkmatIdAvailability()" name="matId" placeholder="Marticulation ID." required="true" autofocus>
